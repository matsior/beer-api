...
INSERT INTO
    beer(name, description, country, alcohol, blg, beer_style_id)
VALUES
       ('Tyskie', 'opis tyskiego', 'Poland', 5.2, 11.7, 1),
       ('Perła Export', 'opis perly', 'Poland', 5.6, null, 3),
       ('Żywiec Białe', 'opis zywca białego', 'Poland', 4.9, 11.6, 2);
